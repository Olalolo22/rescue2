...
export default function Home() {
  ...
  return <main ref={pageRef} className="site-shell console-home">
    ...
    <section data-reveal className="thesis-section"><div className="thesis-grid"><div><span className="section-label">THE PROBLEM</span><h2>Public liquidation is a race the borrower has already lost.</h2></div><div><p>Keepers race against the same visible state. The fastest transaction wins—not necessarily the best recovery.</p><p>Rescue inserts a constrained, confidential window where eligible actors compete on the borrower&apos;s behalf.</p></div></div><div className="contrast-row"><article className="contrast-card danger"><span>PUBLIC LIQUIDATION</span><p><i /> DISTRESS → PUBLIC RACE → VALUE EXTRACTED</p></article><div className="contrast-arrow"><ArrowRight /></div><article className="contrast-card safe"><span>RESCUE PROTOCOL</span><p><i /> PRIVATE COMPETITION → BEST VALID OUTCOME → SETTLEMENT</p></article></div></section>
